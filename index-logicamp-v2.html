 ...
 * index-logicamp-v2.php - Version modernisée respectant l'ancien design
 * Encodage: UTF-8
...
<head>
    ...
    <!-- Font Awesome pour icônes réseaux sociaux -->
    ...
    <nav class="main-navigation">
        <div class="container-fluid">
            <ul class="nav-menu">
                ...
                <li><a href="#account" class="nav-item"><i class="bi bi-person"></i> Account</a></li>
                <li><a href="#immo" class="nav-item"><i class="bi bi-building"></i> IMMO</a></li>
                <li><a href="#freebies" class="nav-item"><i class="bi bi-gift"></i> Freebies</a></li>
                <li><a href="#catalogue" class="nav-item"><i class="bi bi-shop"></i> Catalogue</a></li>
                <li><a href="#tutoriaux" class="nav-item"><i class="bi bi-book"></i> Tutoriaux</a></li>
                <li><a href="#support" class="nav-item"><i class="bi bi-headset"></i> Support</a></li>
