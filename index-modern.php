 ...
 * index.php - ver 4.0.0 MODERN DESIGN
...
<head>
    ...
    <!-- Custom Modern CSS -->
    <link rel="stylesheet" href="//logicamp.org/style-modern.css" type="text/css">
    
    <!-- Scripts originaux -->
    <script type="text/javascript" src="https://www.logicamp.org/inscription/ajax.js"></script>
    <?php include("/wamp/www/settings/script.html"); ?>
</head>
<body>
    ...
    <?php include("/wamp/www/settings/topcss.php"); ?>
    ...
    <?php include("/wamp/www/settings/pied.html"); ?>
    ...
    <?php
    // Logique PHP originale pour les points
